  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <button
        ...
        className={`grid place-items-center rounded border border-[color:var(--line)] text-[color:var(--muted)] duration-200 ease-crisp [transition-property:color,border-color,background-color] hover:border-[color:var(--line-strong)] hover:text-[color:var(--text)] focus-visible:border-gold ${
